...
export default function CompressPdfPage() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const blob = await uploadFile("/api/pdf/compress", formData);
    ...
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      <div className="animate-fade-in-up">
        ...
        <p className="mt-2 text-neutral-400">
          Reduce your PDF file size while keeping acceptable quality.
        </p>
      </div>
      ...
      <div className="mt-8 space-y-6 animate-fade-in">
        ...
        {/* Loading */}
        {loading && <LoadingSpinner message="Compressing your PDF…" />}
        ...
        {/* Download */}
        {resultUrl && (
          <DownloadButton blobUrl={resultUrl} filename="compressed.pdf" />
        )}
      </div>
    </div>
  );
